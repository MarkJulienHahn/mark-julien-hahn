...
import type { WorkData } from "../../types/types"
...
export default function Project({ project, setCurrentIndex, currentIndex, isInitial }: WorkProps) {
  ...
  const portableTextComponents: PortableTextComponents = {
    marks: {
      link: ({ children, value }) => {
        ...
        return (
          <a href={href} rel={rel} target={href && !href.startsWith("/") ? "_blank" : undefined}>
            {children}
          </a>
        )
      },
    ...
    <section className="project" ref={setRefs}>
      <div className="project__information">
        <div className="project__text">
          ...
          <PortableText value={project.description as TypedObject[]} components={portableTextComponents} />
        </div>
        <div className="project__subline text__small">
          ...
          <div className="project__subline--text">
            <PortableText value={project.clientInformation as TypedObject[]} components={portableTextComponents} />
          </div>
        </div>
      </div>
